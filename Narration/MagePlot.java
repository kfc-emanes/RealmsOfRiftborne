...
public class MagePlot {
    ...
    public void mageAfterArea1() { // not implemented
        ...
        String[] afterArea1Narration3 = {
            ...
            "Narration: Principal Voss stands silently, watching you with the weight of something unspoken.\nYou expected a routine debrief... but the tension in the room tells you otherwise.",
            "Principal: \"You\'ve returned,\" he says quietly, voice calm but heavy. \"And yet, something has changed in you.\"",
            ...
            "Principal: \"Survival is only part of it. Your curse… it is more than pain or torment.\"",
            "Selene: \"...What do you mean?\"",
            "Principal Voss: \"Morvain tied your magic to his own influence. Every spell you cast, every surge of your power...\nhe can sense it, manipulate it, even punish you from afar. He\'s always been watching.\"",
    ...
    public void mageAfterArea2() { // not implemented
        ...
        String[] afterArea2Narration3 = {
            ...
            "Narration: Principal stands behind his desk, his gaze steady and unsettlingly calm. You expected praise -\nor at least a routine debrief - but the weight in his eyes immediately tells you this is something far heavier.",
            "Principal: \"Selene,\" he begins, voice low, \"there\'s something you need to know about Project LUCENT.. and those you care about.\"",
            ...
            "Principal: \"During LUCENT, Morvain eliminated or captured many of your family and peers -\nthose who could have stood against him, those who opposed his will.\"",
    ...
    public void mageLoop() {
        ...
        String[] loop = {
            ...
            "Selene: \"Principal... something\'s wrong. I was outside- I killed Morvain- and now I\'m back here?\"",
